<template>
    <div>
        ...
        <p class="pl-5"><br/>This is a simple book list created to demonstrate SPA and CRUD operations in Laravel.  It uses VueJS and Bootstrap on the front-end.<br/><br/>
        <p class="pl-5">
